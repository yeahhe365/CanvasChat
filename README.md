...
**标准版** - `App.jsx`（通用 AI 助手，无预设人设）
```bash
cp App.jsx src/components/
```

**Anna 女友版** - `App-Anna.jsx`（内置 Anna 女友角色设定）
```bash
cp App-Anna.jsx src/components/App.jsx
```

> 💡 **区别说明**：
> - `App.jsx` - 纯净版，可自定义系统提示词
> - `App-Anna.jsx` - 已内置 Anna 女友角色设定，打开即用
